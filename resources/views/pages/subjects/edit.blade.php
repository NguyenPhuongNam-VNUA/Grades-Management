...
@section('page-content')
    <div class="content">
        <form class="row" action="{{ route('subjects.update',['id'=>$subject->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="text" name="name" id="name" value="{{ $subject->name }}" placeholder="Nhập tên môn học...">
                                </div>
                            </div>
                        </div>
                    </div>
