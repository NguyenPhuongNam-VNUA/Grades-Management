        ...
        <div class="page-header-content d-lg-flex border-top">
            <div class="d-flex">
                <div class="breadcrumb py-2">
                    ...
                    <span class="breadcrumb-item active">Thêm mới lớp học</span>
                </div>
            </div>
...
@section('page-content')
    <div class="content">
        <form class="row" action="{{ route('classes.store') }}" method="post" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Nhập tên lớp học...">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="text" name="code" id="code" value="{{ old('code') }}" placeholder="Nhập mã lớp học...">
                                </div>
                                {{--                            @error('description')--}}
